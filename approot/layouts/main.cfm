...
<html lang="en">
	<head>
		...
		<meta name="title" content="ColdFusion API - Dashboard">
		...
		<link href='//fonts.googleapis.com/css?family=Merriweather:400,400italic,700,700italic,300,300italic,900italic,900' rel='stylesheet' type='text/css'>

		<!-- Custom styles for this template -->
		<link href="/includes/css/offcanvas.css" rel="stylesheet">
		<link href="/includes/css/custom_bootstrap.css" rel="stylesheet">
	</head>
	...
	<body>
		...
		<script src="//cdnjs.cloudflare.com/ajax/libs/tether/1.2.0/js/tether.min.js"></script><!-- Tether for Bootstrap -->
